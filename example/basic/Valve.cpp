...
namespace microhsm_examples {
     ...
     */
    /* --- `StateIdle` --- */
    bool StateIdle::match(unsigned int event, microhsm::sTransition* t, void* ctx)
    {
    ...
    /* --- `StateRunning` --- */
    bool StateRunning::match(unsigned int event, microhsm::sTransition* t, void* ctx)
    {
    ...
    /* --- `StateClosed` --- */
    bool StateOpen::match(unsigned int event, microhsm::sTransition* t, void* ctx)
    {
        UNUSED_ARG(ctx);
        switch(event) {
            case eEVENT_TICK:
    ...
    void StateClosed::entry(void* ctx)
    {
        ValveContext* context = static_cast<ValveContext*>(ctx);
        context->close();
    }
